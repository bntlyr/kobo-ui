...
@Component({
  selector: 'app-full-calendar-showcase',
  standalone: true,
  imports: [KTabs, KTabList, KTabTrigger, KTabContent, KFullCalendar],
  template: `
    <div class="space-y-6">
      <div>
        <h1 class="text-3xl font-bold tracking-tight">Full Calendar</h1>
        <p class="text-muted-foreground mt-2">A comprehensive, Apple-style full page calendar component.</p>
      </div>
...
&lt;k-full-calendar class="w-full h-[650px]"&gt;&lt;/k-full-calendar&gt;
            </code></pre>
          </div>
        </k-tab-content>
      </k-tabs>
      ...
      <section class="space-y-4">
        ...
        <div class="space-y-8">
          <div class="space-y-4">
            <h3 class="text-lg font-semibold">KFullCalendar</h3>
            <p class="text-sm text-muted-foreground">Selector: <code class="font-mono bg-muted px-1 py-0.5 rounded text-xs">k-full-calendar</code></p>
...
export default class FullCalendarShowcaseComponent {}
