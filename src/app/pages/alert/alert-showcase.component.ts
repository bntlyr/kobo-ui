...
@Component({
  ...
  imports: [KAlert, KAlertTitle, KAlertDescription, CodeBlockComponent, TabsComponent],
  ...
  template: `
    <div class="space-y-16 max-w-3xl">
      <section class="space-y-6">
        <div class="space-y-2">
          <div class="flex items-center gap-2 text-xs text-muted-foreground font-mono">
            <span>components</span><span>/</span><span class="text-foreground">alert</span>
          </div>
          <h1 class="text-4xl font-bold tracking-tight">Alert</h1>
          <p class="text-lg text-muted-foreground">Inline status messages with 5 variants.</p>
        </div>
      ...
      <section class="space-y-4">
        ...
        <div class="space-y-8">
          <div class="space-y-4">
            <h3 class="text-lg font-semibold">KAlert</h3>
            <p class="text-sm text-muted-foreground">Selector: <code class="font-mono bg-muted px-1 py-0.5 rounded text-xs">k-alert</code></p>
              ...
              <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-border">
                  <tr>
                    ...
                    <td class="px-4 py-3 font-mono text-xs text-primary">'default' | 'info' | 'success' | 'warning' | 'destructive'</td>
                    <td class="px-4 py-3 font-mono text-xs">'default'</td>
                    <td class="px-4 py-3 text-muted-foreground">The visual variant of the alert.</td>
                  </tr>
                  <tr>
          ...
          <div class="space-y-4">
            <h3 class="text-lg font-semibold">KAlertTitle</h3>
            <p class="text-sm text-muted-foreground">Selector: <code class="font-mono bg-muted px-1 py-0.5 rounded text-xs">k-alert-title</code></p>
          ...
          <div class="space-y-4">
            <h3 class="text-lg font-semibold">KAlertDescription</h3>
            <p class="text-sm text-muted-foreground">Selector: <code class="font-mono bg-muted px-1 py-0.5 rounded text-xs">k-alert-description</code></p>
