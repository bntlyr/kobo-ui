...
&lt;/button&gt;
      ...
      <section class="space-y-4">
        ...
        <div class="space-y-8">
          <div class="space-y-4">
            <h3 class="text-lg font-semibold">KToggleDirective</h3>
            <p class="text-sm text-muted-foreground">Selector: <code class="font-mono bg-muted px-1 py-0.5 rounded text-xs">button[k-toggle]</code></p>
            <div class="rounded-xl border border-border overflow-x-auto">
              <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-border">
                  ...
                  <tr>
                    <td class="px-4 py-3 font-mono text-xs">pressed</td>
                    <td class="px-4 py-3 font-mono text-xs text-primary">boolean</td>
                    <td class="px-4 py-3 font-mono text-xs">false</td>
                    <td class="px-4 py-3 text-muted-foreground">Two-way bindable pressed state via <code class="font-mono bg-muted px-1 rounded text-xs">[(pressed)]</code>.</td>
                  </tr>
                </tbody>
              </table>
            </div>
